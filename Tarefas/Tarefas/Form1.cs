    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAdicionar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comandoMySql.CommandText = "INSERT INTO tarefas (dia_da_semana,titulo,descricao) " +
                    "VALUES('" + txtData.Text + "', '" + txtTitulo.Text + "', '" + txtDescricao.Text + "')";
        ...
        private void atualizarGrid()
        {
            ...
            try
            {
                ...
                comandoMySql.CommandText = "SELECT * from tarefas"; //Traz todo mundo da tabela tarefas
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                ...
                txtData.Text = dataGridView1.Rows[e.RowIndex].Cells["dia_da_semana"].FormattedValue.ToString();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand comandoMySql = realizaConexacoBD.CreateCommand(); //Crio um comando SQL
                comandoMySql.CommandText = "UPDATE tarefas SET dia_da_semana = '" + txtData.Text + "', " +
